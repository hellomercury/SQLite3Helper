...
public class SQLite3CreateDemo : MonoBehaviour
{

    SQLite3Operate operate;
    void Start()
    {
        operate = SQLite3Operate.CreateAndWrite("Dynamic.db");
    ...
    void OnGUI()
    {
        ...
        if (GUILayout.Button((isSelectSingleData ? "V" : ">") + "\tSelect single data."))
        {
        ...
        if (isSelectDictData)
        {
            GUILayout.BeginHorizontal();
            GUILayout.Space(64);
            if (GUILayout.Button("Get Item Dictionary by ID"))
            {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Space(64);
            if (GUILayout.Button("Get Item Dictionary by Name"))
            {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Space(64);
            if (GUILayout.Button("Get Item Dictionary by sql command"))
            {
